...
<?php include('header.php');?>
    ...
    <div class="content" id="content">
        ...
        <div class="row no-margin" id="mapa-alertas">
            <!-- ALERTAS -->
            <div class="alertas pull-right" id="alertas">
            ...
            <!-- MAPA -->
            <div class="mapa pull-left" id="mapa">
                <div class="title-section">
                    <div class="vertical-align">
                        <h3>Mapa</h3>
                        ...
                        <li>
                            <a href="dispositivos.php?serv=chih">
                                <p class="vertical-align">
                                    <span class="pulse-red"></span>  ITESM CHIH
                                </p>
                            </a>
                        </li>
                        <li>
                            <a href="dispositivos.php?serv=gdl">
                                <p class="vertical-align">
                                    <span class="pulse-green"></span>  CRIT GDL
                                </p>
                            </a>
                        </li>
                        <li>
                            <a href="dispositivos.php?serv=mty">
                                <p class="vertical-align">
                                    <span class="pulse-green"></span>  ITESM MTY
                                </p>
                            </a>
                        </li>
                        <li>
                            <a href="dispositivos.php?serv=cdmx">
                                <p class="vertical-align">
                                    <span class="pulse-green"></span>  CRIT CDMX
                                </p>
                            </a>
                        </li>
                        <li>
                            <a href="dispositivos.php?serv=slp">
                                <p class="vertical-align">
                                    <span class="pulse-red"></span>  L'ORÉAL SLP
                                </p>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="alertas-table">
                            ...
                            <div class="table-body">
                                ...
                                <div class="row no-margin">
                                    <div class="servidor">
                                        <p class="vertical-align">
                                            <span class="pulse-red"></span>  CRIT Cd. México
                                        </p>
                                    </div>
                                    <div class="dispositivo">
                                        <p class="vertical-align">
